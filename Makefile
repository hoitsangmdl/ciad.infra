...
reload:
	...
	time sh -c 'export PROJECT_KEY="HOIA" && export PROJECT_SLUG="Project A for Hoi" && sudo make pyaddon && make setup up local_repo monitored && sleep 90 && make template_setup project_setup'
